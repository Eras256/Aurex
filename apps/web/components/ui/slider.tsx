...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="block h-4 w-4 rounded-full border border-amber-600 bg-amber-500 shadow-md transition-all focus-visible:outline-none hover:bg-amber-400 cursor-pointer" />
  </SliderPrimitive.Root>
));
