...
const DialogHeader = ({
  ...
  <div
    className={cn(
      'flex flex-col space-y-1.5 text-center sm:text-left border-b border-white/5 pb-3',
      className
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      'flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 border-t border-white/5 pt-4 mt-4',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      'text-sm font-bold font-mono tracking-wider uppercase text-white',
      className
    )}
    {...props}
  />
